...
$string['exclude_self_plagiarism_help'] = 'Enable this option to exclude self-plagiarism in the same course. Matches with assignments from other courses will still be reported.';
