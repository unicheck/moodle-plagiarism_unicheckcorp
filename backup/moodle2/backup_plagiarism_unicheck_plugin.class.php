...
class backup_plagiarism_unicheck_plugin extends backup_plagiarism_plugin {
    ...
    public function define_module_plugin_structure() {
        ...
        $config = new backup_nested_element('unicheck_config', array('id'), array('name', 'value'));
        $pluginwrapper->add_child($configs);
        $configs->add_child($config);
        $config->set_source_table(UNICHECK_CONFIG_TABLE, array('cm' => backup::VAR_PARENTID));
        ...
        if ($userinfo) {
            $ufile->set_source_table(UNICHECK_FILES_TABLE, array('cm' => backup::VAR_PARENTID));
        }
    ...
    public function define_course_plugin_structure() {
        ...
        $unconfig = new backup_nested_element('unicheck_config', array('id'), array('plugin', 'name', 'value'));
