...
class archive_files_checked extends abstract_file_event {
    ...
    public static function get_name() {
        return plagiarism_unicheck::trans('event:archive_files_checked');
    }
    ...
    public function get_description() {
        ...
        return "Archive file with identifier '{$fileid}' checked by Unicheck for the course module with id '{$cmid}'";
    }
}